...
- (UIFont*)boldVersionOfFont:(UIFont*)font {
  // XXXjoe Clearly this doesn't work if your font is not the system font
	return [UIFont fontWithName:@"BitstreamVeraSansMono-Bold" size:12];//[UIFont boldSystemFontOfSize:font.pointSize];
}
...
- (UIFont*)italicVersionOfFont:(UIFont*)font {
  // XXXjoe Clearly this doesn't work if your font is not the system font
  return [UIFont fontWithName:@"BitstreamVeraSansMono-Oblique" size:12];//[UIFont italicSystemFontOfSize:font.pointSize];
}
